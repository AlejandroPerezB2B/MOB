...
% transitionToPeak   : Transition in milliseconds from old to new value
% transitionStay     : Time in milliseconds in the new status
% transitionFromPeak : Transition in milliseconds from new to old value
...
% Known issues: None
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [ret] = MatNICOnlineAtacsPeak(amplitudeArray, n_channels,...
    ...
    try
        ...
        commandId = protocolSet('CODE_COMMAND_ONLINE_ATACS_PEAK');
