...
% socket         : The socket variable for connecting to the COREGUI
%
% Output:
...
% Known issues: None
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [ret] = MatNICOnlineAtdcsChange(amplitudeArray, n_channels, transition, socket)
    ...
    try
        ...
        commandId = protocolSet('CODE_COMMAND_ONLINE_ATDCS_CHANGE');
